...
const ConnectSarathi = dynamic(() => import("@/components/connectSarathi"), { ssr: false });
const Hero = dynamic(() => import("@/components/hero"), { ssr: false });
const LazyLoad = dynamic(() => import("@/components/lazyLoad"), { ssr: false });
const SukoonUnlimited = dynamic(() => import("@/components/sukoonUnlimited"), { ssr: false });
        ...
        <div className="flex flex-col justify-center gap-4 sm:gap-4 md:gap-20 lg:gap-4 xl:gap-4">
          ...
          <ErrorBoundary>
            <div className="sm:flex xs:flex md:flex lg:flex xl:hidden flex-col justify-center items-center mt-auto m-2">
              <p className="text-2xl font-lightFont">Find the <b>right plan for you</b></p>
              <p>Plans designed to bring purpose, connection, and ease to your journey.</p>
            ...
            <div className="hidden sm:hidden xs:hidden md:hidden lg:hidden xl:flex 2xl:flex   flex-col justify-center items-center  ">
              <p className="text-4xl font-lightFont">Find the <b>right plan for you</b></p>
              <p>Plans designed to bring purpose, connection, and ease to your journey.</p>
